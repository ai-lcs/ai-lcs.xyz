...
个人介绍与竞赛经历依据本人提供的简历整理；英文名 Kevin Li 来自 `ai-lcs/ai-lcs` 个人简介。项目依据公开仓库 README，包含 Focus Desk、Blog to WeChat、数学建模 Skill、MUSCLE、美赛开源作品和统计建模实践。奖项完整收录简历中的四项赛事，技能证书单独展示。MUSCLE 展示的是论文复现与实验流程实践，不声称超过论文结果。照片由本人提供，原文件保留于桌面。简历原文件、电话及其他私人材料不在仓库中。
